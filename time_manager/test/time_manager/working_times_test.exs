defmodule TimeManager.WorkingTimesTest do
  ...
  describe "workingtimes" do
    ...
    test "create_working_time/1 with valid data creates a working_time" do
      valid_attrs = %{end: ~U[2022-10-24 14:24:00.000000Z], start: ~U[2022-10-24 14:24:00.000000Z]}

      assert {:ok, %WorkingTime{} = working_time} = WorkingTimes.create_working_time(valid_attrs)
      assert working_time.end == ~U[2022-10-24 14:24:00.000000Z]
      assert working_time.start == ~U[2022-10-24 14:24:00.000000Z]
    end
    ...
    test "update_working_time/2 with valid data updates the working_time" do
      working_time = working_time_fixture()
      update_attrs = %{end: ~U[2022-10-25 14:24:00.000000Z], start: ~U[2022-10-25 14:24:00.000000Z]}

      assert {:ok, %WorkingTime{} = working_time} = WorkingTimes.update_working_time(working_time, update_attrs)
      assert working_time.end == ~U[2022-10-25 14:24:00.000000Z]
      assert working_time.start == ~U[2022-10-25 14:24:00.000000Z]
    end
